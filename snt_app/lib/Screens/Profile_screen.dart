...
import 'package:snt_app/Screens/profile_settings.dart'; // rename paths if needed
...
class _ProfileScreenState extends State<ProfileScreen> {
  // ——— initial data (comes from backend in real app) ———
  String email = "bessie.cooper@ensia.edu.dz";
  String username = "Bessie Cooper";
  List<String> skills = ["Leadership", "UX Design", "Basketball", "Reading"];
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF7A5AF8), // tuned purple
